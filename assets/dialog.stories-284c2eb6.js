import{x as l}from"./lit-element-f10beb07.js";var i=Object.freeze,s=Object.defineProperty,c=(t,r)=>i(s(t,"raw",{value:i(r||t.slice())})),e;const o={render:()=>l(e||(e=c([`
    <button id=basis>
    ...
    <\/script>
  `])))},b={title:"components/Dialog"};var a,n,d;o.parameters={...o.parameters,docs:{...(a=o.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => html\`
    <button id=basis>
      Open the Basis dialog
    </button>
...
//# sourceMappingURL=dialog.stories-284c2eb6.js.map
