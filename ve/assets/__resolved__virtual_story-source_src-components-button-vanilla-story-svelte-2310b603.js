const __resolved__virtual_storySource_srcComponentsButtonVanillaStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsButtonVanillaStorySvelte as default
};
