const __resolved__virtual_storySource_srcComponentsFooterGlobalStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsFooterGlobalStorySvelte as default
};
